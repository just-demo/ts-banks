...
class ToolBar extends Component<any, any> {
    ...
    render() {
        ...
        const redirect = this.getPageAccess(selectedPath) > this.state.access;
...
function withRouter(ClassComponent: any) {
    return function ComponentWithRouterProp(props: any) {
        const location = useLocation();
        const navigate = useNavigate();
        return <ClassComponent {...props} location={location} navigate={navigate}/>;
    };
}
